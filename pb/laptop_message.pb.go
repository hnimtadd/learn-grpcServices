...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x17, 0x70, 0x72, 0x6f, 0x63, 0x65,
	...
	,
	...
	0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65,
...
var file_laptop_message_proto_goTypes = []interface{}{
	(*Laptop)(nil),                // 0: grpcCourse.pcbook.Laptop
	(*CPU)(nil),                   // 1: grpcCourse.pcbook.CPU
	(*Memory)(nil),                // 2: grpcCourse.pcbook.Memory
	(*GPU)(nil),                   // 3: grpcCourse.pcbook.GPU
	(*Storage)(nil),               // 4: grpcCourse.pcbook.Storage
	(*Screen)(nil),                // 5: grpcCourse.pcbook.Screen
	(*Keyboard)(nil),              // 6: grpcCourse.pcbook.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: grpcCourse.pcbook.Laptop.cpu:type_name -> grpcCourse.pcbook.CPU
	2, // 1: grpcCourse.pcbook.Laptop.ram:type_name -> grpcCourse.pcbook.Memory
	3, // 2: grpcCourse.pcbook.Laptop.gpus:type_name -> grpcCourse.pcbook.GPU
	4, // 3: grpcCourse.pcbook.Laptop.storages:type_name -> grpcCourse.pcbook.Storage
	5, // 4: grpcCourse.pcbook.Laptop.screen:type_name -> grpcCourse.pcbook.Screen
	6, // 5: grpcCourse.pcbook.Laptop.keyboard:type_name -> grpcCourse.pcbook.Keyboard
	7, // 6: grpcCourse.pcbook.Laptop.update_at:type_name -> google.protobuf.Timestamp
