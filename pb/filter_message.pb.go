...
var file_filter_message_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65,
...
var file_filter_message_proto_goTypes = []interface{}{
	(*Filter)(nil), // 0: grpcCourse.pcbook.Filter
	(*Memory)(nil), // 1: grpcCourse.pcbook.Memory
}
var file_filter_message_proto_depIdxs = []int32{
	1, // 0: grpcCourse.pcbook.Filter.min_ram:type_name -> grpcCourse.pcbook.Memory
